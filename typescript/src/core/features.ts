...
import {
    ArrayTypeTraverser,
    ConditionalTypeTraverser,
    ConstructorTypeTraverser,
    FunctionTypeTraverser,
    ImportTypeTraverser,
    IndexedAccessTypeTraverser,
    InferTypeTraverser,
    IntersectionTypeTraverser,
    LiteralTypeTraverser,
    MappedTypeTraverser,
    NamedTupleMemberTraverser,
    OptionalTypeTraverser,
    QualifiedNameTraverser,
    RestTypeTraverser,
    TemplateLiteralTypeTraverser,
    TupleTypeTraverser,
    TypeAnnotationTraverser,
    TypeLiteralTraverser,
    TypeOperatorTraverser,
    TypePredicateTraverser,
    TypeQueryTraverser,
    TypeReferenceTraverser,
    UnionTypeTraverser
} from "./traversers/type.traverser";
import { IndexedAccessTypeCleanupProcessor, IndexedAccessTypeProcessor } from "./processors/type-annotation.processor";
...
export const TRAVERSERS: Map<AST_NODE_TYPES, Traverser> = new Map([
    ...
    [AST_NODE_TYPES.TSConditionalType, new ConditionalTypeTraverser()],
    [AST_NODE_TYPES.TSConstructorType, new ConstructorTypeTraverser()],
    ...
    [AST_NODE_TYPES.TSImportType, new ImportTypeTraverser()],
    [AST_NODE_TYPES.TSIndexedAccessType, new IndexedAccessTypeTraverser()],
    [AST_NODE_TYPES.TSInferType, new InferTypeTraverser()],
    ...
    [AST_NODE_TYPES.TSLiteralType, new LiteralTypeTraverser()],
    [AST_NODE_TYPES.TSMappedType, new MappedTypeTraverser()],
    [AST_NODE_TYPES.TSMethodSignature, new MethodTraverser()],
    [AST_NODE_TYPES.TSNamedTupleMember, new NamedTupleMemberTraverser()],
    [AST_NODE_TYPES.TSNonNullExpression, new NonNullExpressionTraverser()],
    [AST_NODE_TYPES.TSOptionalType, new OptionalTypeTraverser()],
    ...
    [AST_NODE_TYPES.TSQualifiedName, new QualifiedNameTraverser()],
    [AST_NODE_TYPES.TSRestType, new RestTypeTraverser()],
    [AST_NODE_TYPES.TSTemplateLiteralType, new TemplateLiteralTypeTraverser()],
    ...
    [AST_NODE_TYPES.TSTypeLiteral, new TypeLiteralTraverser()],
    [AST_NODE_TYPES.TSTypeOperator, new TypeOperatorTraverser()],
    [AST_NODE_TYPES.TSTypePredicate, new TypePredicateTraverser()],
    ...
    [AST_NODE_TYPES.TSTypeQuery, new TypeQueryTraverser()],
...
export const PROCESSORS: Processor[] = [
    ...
    new IndexedAccessTypeProcessor(),
    new IndexedAccessTypeCleanupProcessor(),
