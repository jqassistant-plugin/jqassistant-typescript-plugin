...
public class DeclarationAssertions {
    ...
    public DeclarationAssertions assertModulePresence() {
        Optional<ModuleDescriptor> moduleDescriptorOptional = project.getModules().stream()
            .filter((mod) -> mod.getFqn().equals("./src/testDeclarations.ts"))
            .findFirst();
    ...
    public DeclarationAssertions assertVariableDeclaration() {
        ...
        assertThat(decl)
            ...
            .hasFieldOrPropertyWithValue("fqn", "\"./src/testDeclarations.ts\".CONSTANT")
    ...
    public DeclarationAssertions assertFunctionDeclaration() {
        ...
        assertThat(decl)
            ...
            .hasFieldOrPropertyWithValue("fqn", "\"./src/testDeclarations.ts\".func")
        ...
        assertThat(decl.getTypeParameters())
            ...
            .anySatisfy((tp) -> {
                ...
                assertThat(tp.getConstraint())
                    ...
                    .hasFieldOrPropertyWithValue("referencedFqn", "\"./src/utils.ts\".BaseInterface")
    ...
    public DeclarationAssertions assertClassDeclaration() {
        ...
        assertThat(decl)
            ...
            .hasFieldOrPropertyWithValue("fqn", "\"./src/testDeclarations.ts\".Class")
        ...
        assertThat(decl.getExtendsClass())
            ...
            .isNotNull()
            .isInstanceOf(TypeDeclaredDescriptor.class)
            .hasFieldOrPropertyWithValue("referencedFqn", "\"./src/utils.ts\".BaseClass")
            .extracting("typeArguments", InstanceOfAssertFactories.LIST)
                .hasSize(0);
...
//            .hasSize(3);
        ...
        assertThat(decl.getProperties())
            ...
            .anySatisfy((p) -> {
                assertThat(p)
                    .hasFieldOrPropertyWithValue("fqn", "\"./src/testDeclarations.ts\".Class.x")
            ...
            .anySatisfy((p) -> {
                assertThat(p)
                    .hasFieldOrPropertyWithValue("fqn", "\"./src/testDeclarations.ts\".Class.z")
        ...
        assertThat(decl.getAccessorProperties())
            ...
            .hasSize(2)
            .anySatisfy((a) -> {
                assertThat(a.getFqn()).isEqualTo("\"./src/testDeclarations.ts\".Class.y");
            ...
            .anySatisfy((a) -> {
                assertThat(a.getFqn()).isEqualTo("\"./src/testDeclarations.ts\".Class.w");
        ...
        assertThat(methodDecl)
            ...
            .hasFieldOrPropertyWithValue("fqn", "\"./src/testDeclarations.ts\".Class.method")
    ...
    public DeclarationAssertions assertInterfaceDeclaration() {
        ...
        assertThat(decl)
            ...
            .hasFieldOrPropertyWithValue("fqn", "\"./src/testDeclarations.ts\".Interface")
        ...
        assertThat(decl.getProperties())
            ...
            .anySatisfy((p) -> {
                assertThat(p)
                    .hasFieldOrPropertyWithValue("fqn", "\"./src/testDeclarations.ts\".Interface.prop")
        ...
        assertThat(decl.getAccessorProperties())
            ...
            .hasSize(2)
            .anySatisfy((a) -> {
                assertThat(a.getFqn()).isEqualTo("\"./src/testDeclarations.ts\".Interface.getter");
            ...
            .anySatisfy((a) -> {
                assertThat(a.getFqn()).isEqualTo("\"./src/testDeclarations.ts\".Interface.setter");
        ...
        assertThat(methodDecl)
            .as("method declaration has all properties set correctly")
            .hasFieldOrPropertyWithValue("fqn", "\"./src/testDeclarations.ts\".Interface.method")
            .hasFieldOrPropertyWithValue("name", "method")
            .hasFieldOrPropertyWithValue("visibility", "public")
            .hasFieldOrPropertyWithValue("async", false)
            .hasFieldOrPropertyWithValue("static", null)
    ...
    public DeclarationAssertions assertEnumDeclaration() {
        ...
        assertThat(decl)
            ...
            .hasFieldOrPropertyWithValue("fqn", "\"./src/testDeclarations.ts\".Enum")
        ...
        assertThat(decl.getMembers())
            ...
            .hasSize(2)
            .anySatisfy((em) -> {
                assertThat(em.getFqn()).isEqualTo("\"./src/testDeclarations.ts\".Enum.ELEM1");
                assertThat(em.getName()).isEqualTo("ELEM1");
            })
            .anySatisfy((em) -> {
                assertThat(em.getFqn()).isEqualTo("\"./src/testDeclarations.ts\".Enum.ELEM2");
